...
*   **打破思维定势**：亲和图的核心严禁预设分类。应让数据点在讨论中自然“聚拢”，通过亲和性建立逻辑岛屿。
*   **异常点的价值**：每一个无法归入现有分组的独立事项（孤岛点），往往代表了一个被忽视的新维度或创新的突破口。
*   **适用的阶段**：最适合用于 QC 成果的“选题理由”或“初步原因搜寻”阶段，将混沌的感性语言转化为结构化的理性逻辑。

---
*Smart QC Studio - 亲和分析研究组*
